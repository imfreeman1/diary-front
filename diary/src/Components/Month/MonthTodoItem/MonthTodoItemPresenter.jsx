...
const MonthTodoItemPresenter = ({ dayInfo, todo, ctrEditModal }) => (
  <>
    <div
      ...
      role="button"
      tabIndex={0}
      className="block truncate bg-gradient-to-r text-white from-gray-500 from-10% via-gray-400 via-50% to-gray-100 to-70% opacity-100 p-1 pl-2 my-2.5 mx-0.5 rounded hover:text-black hover:from-gray-400 hover:cursor-pointer"
    >
      {todo.todoContent}
    </div>
